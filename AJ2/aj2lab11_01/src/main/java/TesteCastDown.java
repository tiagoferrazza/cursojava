public class TesteCastDown {
    ...
    public static void main(String[] args) {
        ...
        if (conta instanceof ContaPoupanca) {
            ...
            System.out.println("Essa conta eh uma Conta Especial.");
            System.out.println("O limite estabelecido eh de " + contaEspecial.getLimite());
        } else {
            
            // em caso negativo imprima uma mensagem afirmando que é uma conta simples
            System.out.println("Essa conta eh uma Conta Simples.");
        }
